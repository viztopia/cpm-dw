...
with tf.device(tf_device):
    ...
    for person_dir in os.listdir(dataset_dir):
        ...
        for idx, line in enumerate(gt_content):
            ...
            cur_hand_joints_x = [float(i) for i in line[5:49:2]]
            # print(line[5])
            # print(line[6])
            # print(line[7])
            # print(line[8])
            ...
            cur_hand_joints_y = [float(i) for i in line[6:49:2]]
            ...
            if cur_img.shape[0] > cur_img.shape[1]:
                ...
                if SHOW_INFO:
                    ...
                    for i in range(num_of_joints):
                        ...
                        part_heatmap = cpm_utils.gaussian_img(box_size, box_size, cur_hand_joints_x[i],
                ...
                # a = list(cur_hand_joints_x)

                cur_hand_joints_x = np.asarray(list(cur_hand_joints_x))

                # print(cur_hand_joints_x)
                cur_hand_joints_y = np.asarray(list(cur_hand_joints_y))
                # print(cur_hand_joints_y)
